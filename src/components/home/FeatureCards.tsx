            ...
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 01-6.001 0M18 7l-3 9m3-9l-6-2m0 2l3 1m-3-1l-3 9"
                />
              </svg>
            </div>
            <h3 className="text-lg sm:text-xl font-bold text-blue-900 mb-3 sm:mb-4">
              {t("fairAssessment.title")}
            </h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              {t("fairAssessment.description")}
            </p>
          </div>
